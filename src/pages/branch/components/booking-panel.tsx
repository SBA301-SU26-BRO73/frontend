        ...
        <div className="sticky top-24 space-y-stack-lg">
          ...
          <div className="bg-surface-container-lowest border border-outline-variant shadow-xl rounded-2xl p-stack-lg">
            ...
            <div className="space-y-stack-md">
              ...
              <button className="w-full bg-primary text-on-primary py-4 rounded-xl font-headline-md text-headline-md hover:scale-[1.01] transition-transform shadow-lg shadow-primary/20">
                Book Now
              </button>
